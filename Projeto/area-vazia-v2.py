...
def definir_cor_fundo(imagem_pote_vazio, raio_buffer=5):
...
def detectar_racao(imagem, cor_fundo_hsv, circulo_pote, area_threshold, raio_buffer=5):
    # Carrega a imagem
...
cor_fundo_hsv, circulo_pote = definir_cor_fundo(imagem_pote_vazio)

imagem_pote = 'caminho/para/sua/imagem.jpg'
area_threshold = 0.2  # 20% da área do pote visível
resultado = detectar_racao(imagem_pote, cor_fundo_hsv, circulo_pote, area_threshold)
